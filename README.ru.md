...
- Обязательный локальный compliance triage; powerful compliance review запускается только для применимого дизайна/плана, изменения публичного API, high-risk домена или конфликта с явным контрактом
...
./install.sh validate # Сгенерировать все платформы во временных каталогах и проверить контракты скиллов
