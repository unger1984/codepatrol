...
AI-скиллы с осведомлённостью о проекте для [Claude Code](https://docs.anthropic.com/en/docs/claude-code), [Codex CLI](https://github.com/openai/codex) и [Cursor](https://cursor.com). Расширяет стандартный воркфлоу [Superpowers](https://github.com/obra/superpowers) знанием правил и документации проекта.
...
./install.sh codex   # Собрать и установить в ~/.agents/skills/
...
.\install.ps1 codex   # Собрать и установить в ~/.agents/skills/
...
- Поддержка Cursor экспериментальная
