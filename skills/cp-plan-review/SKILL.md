...
- **APPROVED / APPROVED_WITH_NOTES** — the plan is execution-ready. Skip `/cp-plan-fix` and offer `/cp-execute` directly. Use the Skill tool to invoke the target skill directly.
